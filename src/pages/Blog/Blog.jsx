                    ...
                    <div className="flex items-center  overflow-x-auto overflow-y-hidden sm:justify-start flex-nowrap dark:bg-gray-100 dark:text-gray-800">
                        <Link
                            ...
                            className={`flex items-center flex-shrink-0 px-5 py-3 space-x-2 ${
                                tabIndex === 0
                                    ? "border-solid border-2 border-b-0"
                                    : "border-b"
                        ...
                        <div onClick={()=> handleBookmark(blog)} className="ml-5 p-2 rounded-full bg-primary bg-opacity-20 hover:scale-105 hover:bg-opacity-30 cursor-pointer overflow-hidden">
                            <MdBookmarkAdd
                                size={20}
